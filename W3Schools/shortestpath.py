...
class Graph:
    ...
    def add_edge(self, u, v, weight): # Add weight for directed and weighted graphs
        if 0 <= u < self.size and 0 <= v < self.size:
            self.adj_matrix[u][v] = weight # Change 1 to weight for directed and weighted graphs
            # self.adj_matrix[v][u] = weight # Remove this line for directed and weighted graphs
